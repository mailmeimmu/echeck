/*
  ...
  1. Changes
    - Update admin email constraint to use @check.sa domain
    - Create platform admin user with proper credentials
    - Set up proper permissions and profile
*/
...
-- Update admin_users table constraint to use @check.sa
...
BEGIN
  -- Create platform admin user with @check.sa domain
