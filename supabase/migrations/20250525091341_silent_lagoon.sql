/*
  # Add Submit Inspection Function
  
  1. New Functions
    - `submit_inspection`: Handles inspection submission with proper error handling
      - Processes inspection data, photos, and notes
      - Updates booking status
      - Deletes draft after successful submission
      
  2. Security
    - Function is accessible to authenticated engineers only
    - Validates engineer status and booking ownership
*/
