/*
  ...
  1. Changes
    - Update engineer request policies to show pending requests
...
DROP POLICY IF EXISTS "Engineers can view open requests" ON engineer_requests;
DROP POLICY IF EXISTS "Admin can view all requests" ON engineer_requests;
