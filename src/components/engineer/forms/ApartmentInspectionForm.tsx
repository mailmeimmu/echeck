...
const apartmentPropertyType: PropertyType = {
  id: 'apartment',
  title: 'شقة',
  areas: [
    {
...
export const ApartmentInspectionForm = (props: InspectionFormProps) => {
  return <BaseInspectionForm {...props} propertyTypes={[apartmentPropertyType]} />;
};