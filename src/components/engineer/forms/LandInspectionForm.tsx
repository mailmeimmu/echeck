...
const landPropertyType: PropertyType = {
  id: 'land',
  title: 'أرض',
  areas: [
    {
...
export const LandInspectionForm = (props: InspectionFormProps) => {
  return <BaseInspectionForm {...props} propertyTypes={[landPropertyType]} />;
};