...
const villaPropertyType: PropertyType = {
  id: 'villa',
  title: 'فيلا',
  areas: [
    {
...
export const VillaInspectionForm = (props: InspectionFormProps) => {
  return <BaseInspectionForm {...props} propertyTypes={[villaPropertyType]} />;
};